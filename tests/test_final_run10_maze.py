#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""final_run10 판단층 단위 테스트 — PC 단독 실행(ev3dev2 불필요).
...
실행: python3 tests/test_final_run10_maze.py
"""
...
from old_stages.final_run10 import (Explorer, PidSteer, classify_rgb, node_bits,
...
class HtmlMazeCase(unittest.TestCase):
    ...
    def test_route_step_count_minimal(self):
        ...
        from old_stages.final_run10 import shortest_path
