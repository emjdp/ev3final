...
실행(브릭):   python3 stages/final_run2.py
문법 점검(PC): python3 -m py_compile stages/final_run2.py lib/*.py
"""
...
SAVE_PATH = os.path.join(_ROOT, "config", "final_run2.json")
STAGE_NAME = "final_run2"
...
def run():
    ...
    print("final_run2 ready. put robot ON the line and run dashboard 'calibrate' "
    ...
    try:
        ...
        try:
            ...
            server.stop()
    print("final_run2 stopped. sessions={}".format(runner.session))
