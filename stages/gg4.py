#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""gg4 — gg3 + PD 라이브 튜닝·거리 결정형 confirm·배달 단순화.
...
실행(브릭):   python3 stages/gg4.py
문법 점검(PC): python3 -m py_compile stages/gg4.py lib/*.py
단위 테스트:  python3 tests/test_gg4_logic.py (ev3dev2 불필요)
"""
...
SAVE_PATH = os.path.join(_ROOT, "config", "gg4.json")
STAGE_NAME = "gg4"
...
def run():
    ...
    print("gg4 ready. 1) dashboard 'calibrate' on the line, 2) place robot "
    ...
    try:
        ...
        try:
            ...
            server.stop()
    print("gg4 stopped. sessions={}".format(runner.session))
