#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""gg2 — gg1 + 복귀 내성(커브 오인식 허용/빨강 재동기화) + 교차로 접근 가드.
...
실행(브릭):   python3 stages/gg2.py
문법 점검(PC): python3 -m py_compile stages/gg2.py lib/*.py
단위 테스트:  python3 tests/test_gg2_logic.py (ev3dev2 불필요)
"""
...
SAVE_PATH = os.path.join(_ROOT, "config", "gg2.json")
STAGE_NAME = "gg2"
...
def run():
    ...
    print("gg2 ready (silent). 1) dashboard 'calibrate' on the line, "
    ...
    try:
        ...
        try:
            ...
            server.stop()
    print("gg2 stopped. sessions={}".format(runner.session))
