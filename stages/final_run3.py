...
SAVE_PATH = os.path.join(_ROOT, "config", "final_run3.json")
STAGE_NAME = "final_run3"
...
def run():
    ...
    print("final_run3 ready. put robot ON the line and run dashboard 'calibrate' "
    ...
    try:
        ...
        try:
            ...
            server.stop()
    print("final_run3 stopped. sessions={}".format(runner.session))
