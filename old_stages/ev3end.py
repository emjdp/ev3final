...
SAVE_PATH = os.path.join(_ROOT, "config", "ev3end.json")
STAGE_NAME = "ev3end"
...
def run():
    ...
    print("ev3end ready (SILENT — sound removed). 1) dashboard 'calibrate' on "
    ...
    try:
        ...
        try:
            ...
            server.stop()
    print("ev3end stopped. sessions={}".format(runner.session))
